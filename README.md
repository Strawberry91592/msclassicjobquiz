# MapleStory Classic World — Playstyle to 2nd Job Quiz
...
- Job profiles are based on their actual strengths, weaknesses, and playstyles, using data from **NiaMeowDB and other Classic World community sources**.
